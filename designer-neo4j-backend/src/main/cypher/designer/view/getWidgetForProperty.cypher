...
WITH CASE
       ...
       WHEN prop.name = 'type' AND typeName = 'Typed' THEN {widgetType: 'dropDown', initValues: ['string', 'varchar', 'integer', 'float', 'boolean', 'date', 'datetime', 'localdatetime', 'localtime', 'time', 'duration', 'Node', 'Relationship']}
